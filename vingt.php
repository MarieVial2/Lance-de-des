    ...
    <section>
        <div id="choix">
            ...
            <div>
                ...
                <a href="vingt.php"><button type="submit" class="btn btn-outline-warning active" >Dé à 20 faces</button></a>
                <a href="choix.php"><button type="submit" class="btn btn-outline-warning" >Au choix</button></a>
            </div>
        </div>

        <form action="vingt.php" method="post">
        ...
        <div class="nombre">
        <?php if (isset($_POST['nombre']) && $_POST['nombre'] == 1) {
                        echo "<p>";
                        echo rand(1, 20);
                        echo "</p>";
                    }
